 ...
 * @author Hp
 */
public class FollowsOtro extends javax.swing.JFrame {
public Master mas;
   
    public FollowsOtro(Master mast) {
        initComponents();
        mas=mast;
        this.setTitle("Mi Perfil ( @"+mas.UsuarioBusqueda.getUser()+" )");
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(165, 165, 165)
                        .addComponent(lblListName, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(0, 0, Short.MAX_VALUE))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(lblListName, javax.swing.GroupLayout.PREFERRED_SIZE, 16, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnFolowingMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnFolowingMouseClicked
        //MOSTAR SEGUIDOS
        AreaFollows.setText("");
        lblListName.setText("Following");
            for (int i =0; i < mas.UsuarioBusqueda.getNumFollowing(); i++) {
            String Follows=mas.UsuarioBusqueda.getfollowing()[i] +"\n \n"+ AreaFollows.getText();
    ...
    private void btnFollowerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnFollowerMouseClicked
        //MostrarSeguidores
        AreaFollows.setText("");
        lblListName.setText("Followers");
        for (int i =0; i < mas.UsuarioBusqueda.getNumFollowers(); i++) {
            String Follows=mas.UsuarioBusqueda.getfollowers()[i] +"\n \n"+ AreaFollows.getText();
            AreaFollows.setText(Follows);
        }   
